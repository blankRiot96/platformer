...
from src.shared import CHUNK_SIZE, CHUNK_TILES
...
class Chunk:
    ...
    def write_to_disk(self) -> None:
        serializable_chunk_data = {
            cell: partial(type(entity), *self.get_entity_args(entity))
    ...
    def on_removal(self) -> None:
        for entity in self.cells.values():
            entity.on_removal()
